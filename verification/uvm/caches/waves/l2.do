...
add wave -noupdate /tb_caches_top/l2_cif/nRST
add wave -noupdate -expand -group arb_l2_bus_if /tb_caches_top/arb_l2_bus_if/addr
add wave -noupdate -expand -group arb_l2_bus_if /tb_caches_top/arb_l2_bus_if/wdata
add wave -noupdate -expand -group arb_l2_bus_if /tb_caches_top/arb_l2_bus_if/rdata
add wave -noupdate -expand -group arb_l2_bus_if /tb_caches_top/arb_l2_bus_if/ren
add wave -noupdate -expand -group arb_l2_bus_if /tb_caches_top/arb_l2_bus_if/wen
add wave -noupdate -expand -group arb_l2_bus_if /tb_caches_top/arb_l2_bus_if/busy
...
add wave -noupdate -group l2 -group params /tb_caches_top/l2/CACHE_SIZE
add wave -noupdate -group l2 -group params /tb_caches_top/l2/BLOCK_SIZE
add wave -noupdate -group l2 -group params /tb_caches_top/l2/ASSOC
add wave -noupdate -group l2 -group params /tb_caches_top/l2/NONCACHE_START_ADDR
add wave -noupdate -group l2 -group params /tb_caches_top/l2/N_TOTAL_BYTES
add wave -noupdate -group l2 -group params /tb_caches_top/l2/N_TOTAL_WORDS
add wave -noupdate -group l2 -group params /tb_caches_top/l2/N_TOTAL_FRAMES
add wave -noupdate -group l2 -group params /tb_caches_top/l2/N_SETS
add wave -noupdate -group l2 -group params /tb_caches_top/l2/N_FRAME_BITS
add wave -noupdate -group l2 -group params /tb_caches_top/l2/N_SET_BITS
add wave -noupdate -group l2 -group params /tb_caches_top/l2/N_BLOCK_BITS
add wave -noupdate -group l2 -group params /tb_caches_top/l2/N_TAG_BITS
add wave -noupdate -group l2 -group params /tb_caches_top/l2/FRAME_SIZE
add wave -noupdate -group l2 -group params /tb_caches_top/l2/L1_BLOCK_SIZE
...
add wave -noupdate -group l2_cif /tb_caches_top/l2_cif/clear
add wave -noupdate -group l2_cif /tb_caches_top/l2_cif/flush
add wave -noupdate -group l2_cif /tb_caches_top/l2_cif/clear_done
add wave -noupdate -group l2_cif /tb_caches_top/l2_cif/flush_done
...
update
WaveRestoreZoom {5994050 ps} {5995050 ps}
