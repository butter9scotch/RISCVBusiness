...
add wave -noupdate -radix binary /tb_FPU_top_level/DUT/add_step3/frac
add wave -noupdate -radix binary /tb_FPU_top_level/DUT/add_step3/exponent
add wave -noupdate -radix binary /tb_FPU_top_level/DUT/add_step3/sign
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {42680000 ps} 0}
...
update
WaveRestoreZoom {42669274 ps} {42690726 ps}
